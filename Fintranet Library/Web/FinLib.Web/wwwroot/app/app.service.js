altairApp
    ...
    .service('preloaders', [
        ...
        function ($rootScope, $timeout, utils) {
            $rootScope.content_preloader_show = $rootScope.showPreloader = function (style, variant, container, width, height) {
            ...
            $rootScope.content_preloader_hide = $rootScope.hidePreloader = function () {
