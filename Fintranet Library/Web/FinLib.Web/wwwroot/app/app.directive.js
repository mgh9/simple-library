            ...
            return {
                ...
                link: function () {
                    var listener = function (event, toState) {
                        var default_title = 'Fin Library';

                        $timeout(function () {
                            $rootScope.state_title = toState.data.pageTitle;
            ...
            return {
                ...
                controller: function ($scope, $element) {
                    ...
                    $scope.updateInput = function () {
                        ...
                        if ($elem.hasClass('md-input-warning')) {
                            $elem.closest('.md-input-wrapper').addClass('md-input-wrapper-warning')
                        }
